<aside id="sidebar" class="w-64 glass-panel sidebar-transition border-r min-h-screen flex flex-col z-50">
    <div class="p-6 flex items-center gap-4">
        <img src="{{ asset('assets/images/logo.png') }}" alt="Logo" style="height: 4rem; width: auto; display: block;" class="object-contain transform hover:scale-105 transition-transform duration-300">
    ...
    <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
        ...
        <div class="pt-6 text-[10px] uppercase tracking-widest text-[#45A29E] font-bold px-4 mb-2 opacity-60">Management</div>
        ...
        <div class="pt-6 text-[10px] uppercase tracking-widest text-[#45A29E] font-bold px-4 mb-2 opacity-60">Global Reach</div>
