...
<style>
    ...
    .identity-orb-top {
        ...
        width: 150px;
        height: 150px;
        background: radial-gradient(circle, #66FCF1, transparent);
        opacity: 0.3;
        border-radius: 50%;
    }
...
<div class="profile-wrap animate-fade-in mb-8">
    ...
    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px;">
        <div style="display:flex; align-items:center; gap:16px;">
            ...
            <div>
                <h2
                    style="color:#fff; font-size:26px; font-weight:800; margin:0; line-height:1.2; font-family:'Plus Jakarta Sans',sans-serif;">
                    Profile Center</h2>
                <p
                    style="color:#C5C6C7; font-size:13px; font-weight:500; margin:4px 0 0; opacity:0.6; font-family:'Plus Jakarta Sans',sans-serif;">
                    Configure your master administration account</p>
            </div>
        </div>

        <div
            style="display:flex; align-items:center; gap:12px; padding:8px 16px; border-radius:12px; background:rgba(52,211,153,0.05); border:1px solid rgba(52,211,153,0.15);">
            <div
                style="width:8px; height:8px; border-radius:50%; background:#4ade80; box-shadow:0 0 10px rgba(52,211,153,0.8);">
            </div>
            <span
                style="color:#4ade80; font-size:11px; font-weight:800; text-transform:uppercase; letter-spacing:0.1em; font-family:'Plus Jakarta Sans',sans-serif;">Systems
                Nominal</span>
        </div>
    </div>
    ...
    <div class="profile-grid">
        ...
        <div style="display:flex; flex-direction:column; gap:24px;">
            ...
            <div class="pcard identity-card">
                ...
                <div style="padding:0 24px 24px 24px; text-align:center;">
                    <label for="avatarInput" class="avatar-box" 
                           style="{{ $result->image ? 'background: url(/uploads/'.$result->image.') center/cover no-repeat; color: transparent;' : '' }}">
                        {{ $result->image ? '' : 'A' }}
                    ...
                    <h3
                        ...
                        System Admin</h3>
                    <p
                        style="color:#45A29E; font-size:13px; font-weight:500; margin:0 0 20px; font-family:'Plus Jakarta Sans',sans-serif;">
                        Level 4 Overseer</p>

                    <div
                        style="display:grid; grid-template-columns:1fr 1fr; gap:12px; padding-top:20px; border-top:1px dashed rgba(255,255,255,0.08);">
                        <div>
                            <p
                                style="color:#fff; font-size:20px; font-weight:900; margin:0; line-height:1; font-family:'Plus Jakarta Sans',sans-serif;">
                                247</p>
                            <p
                                style="color:rgba(197,198,199,0.5); font-size:10px; font-weight:700; text-transform:uppercase; letter-spacing:0.07em; margin:6px 0 0; font-family:'Plus Jakarta Sans',sans-serif;">
                                Actions</p>
                        </div>
                        <div>
                            <p
                                style="color:#66FCF1; font-size:20px; font-weight:900; margin:0; line-height:1; font-family:'Plus Jakarta Sans',sans-serif;">
                                99%</p>
                            <p
                                style="color:rgba(197,198,199,0.5); font-size:10px; font-weight:700; text-transform:uppercase; letter-spacing:0.07em; margin:6px 0 0; font-family:'Plus Jakarta Sans',sans-serif;">
                                Uptime</p>
            ...
            <div
                style="padding:20px; border-radius:20px; border:1px solid rgba(239,68,68,0.15); background:rgba(239,68,68,0.03);">
                ...
                <h4
                    style="color:#fff; font-size:14px; font-weight:700; text-align:center; margin:0 0 4px; font-family:'Plus Jakarta Sans',sans-serif;">
                    Danger Zone</h4>
                <p
                    style="color:rgba(248,113,113,0.6); font-size:11px; text-align:center; margin:0 0 16px; font-family:'Plus Jakarta Sans',sans-serif;">
                    Permanently delete this account and all associated operational data. Irreversible.</p>
                <button type="button" class="btn-ghost"
                    style="color:#f87171; border-color:rgba(239,68,68,0.3); background:transparent;"
        ...
        <div style="display:flex; flex-direction:column; gap:24px;">
            ...
            <div class="pcard" style="padding: 28px;">
                <div
                    style="display:flex; align-items:center; gap:14px; padding-bottom:20px; border-bottom:1px solid rgba(255,255,255,0.06); margin-bottom:24px;">
                    <div class="sec-badge"
                    ...
                    <div>
                        <h4
                            style="color:#fff; font-size:16px; font-weight:800; margin:0; font-family:'Plus Jakarta Sans',sans-serif; line-height:1.2;">
                            Basic Information</h4>
                        <p
                            style="color:#45A29E; font-size:11px; margin:4px 0 0; opacity:0.7; font-family:'Plus Jakarta Sans',sans-serif;">
                            Update your credentials</p>
                    </div>
                </div>

                <form id="profileForm" method="post" action="/admin/update/{{ $result->id }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                        <button type="button" class="btn-ghost"
                            onclick="document.getElementById('profileForm').reset()">Discard</button>
            ...
            <div class="pcard" style="padding: 28px;">
                <div
                    style="display:flex; align-items:center; gap:14px; padding-bottom:20px; border-bottom:1px solid rgba(255,255,255,0.06); margin-bottom:24px;">
                    <div class="sec-badge"
                        style="background:rgba(255,159,67,0.1); border:1px solid rgba(255,159,67,0.2);">
                    ...
                    <div>
                        ...
                        <p
                            style="color:#45A29E; font-size:11px; margin:4px 0 0; opacity:0.7; font-family:'Plus Jakarta Sans',sans-serif;">
                            Manage operational access</p>
                    </div>
                </div>

                <form id="securityForm" method="post" action="/admin/update/{{ $result->id }}">
                    @csrf
                    <div style="margin-bottom:20px;">
                    ...
                    <div class="field-grid" style="margin-bottom:8px;">
                        ...
                        <div>
                            ...
                            <div class="pw-wrap">
                                <input class="form-input" type="password" id="confirmPwd" placeholder="Repeat password"
                                    oninput="checkMatch()">
                    ...
                    <div id="strengthWrap" style="display:none; margin-bottom:28px;">
                        <div style="display:flex; justify-content:space-between; margin-bottom:6px;">
                            <span
                                style="font-size:10px; font-weight:700; text-transform:uppercase; letter-spacing:0.07em; color:rgba(197,198,199,0.4); font-family:'Plus Jakarta Sans',sans-serif;">Password
                                Strength</span>
                            <span id="strengthLabel"
                                style="font-size:10px; font-weight:700; text-transform:uppercase; letter-spacing:0.07em; font-family:'Plus Jakarta Sans',sans-serif;"></span>
                        </div>
                        <div
                            style="height:4px; width:100%; background:rgba(255,255,255,0.06); border-radius:99px; overflow:hidden;">
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                        <button type="button" class="btn-ghost"
                            onclick="document.getElementById('securityForm').reset(); document.getElementById('strengthWrap').style.display='none'; document.getElementById('spacer').style.display='block';">Clear</button>
